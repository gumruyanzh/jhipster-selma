...
import { DtotestTestModule } from '../../../test.module';
...
describe('Component Tests', () => {
    ...
    describe('Post Management Detail Component', () => {
        ...
        describe('OnInit', () => {
            ...
            spyOn(service, 'find').and.returnValue(Observable.of(new Post('aaa')));
            ...
            expect(comp.post).toEqual(jasmine.objectContaining({id: 'aaa'}));
            });
        });
    });
